...
import Header from '../HeaderFunction/header.js'
            ...
            <View style={{ backgroundColor: 'white', borderRadius: 10, padding: 20 }}>
              ...
              <ScrollView>
                ...
                {recipe.ingredients.map((ingredient, index) => (
                  ...
                  <View key={index} style={{ backgroundColor: '#f5f5f5', borderRadius: 5, marginBottom: 5 }}>
              ...
              <TouchableOpacity onPress={() => setModalVisible(false)} style={{ marginTop: 20 }}>
                ...
                <Text style={{ fontSize: 16, color: 'blue', textAlign: 'center' }}>Fechar</Text>
